  ...
  : QMainWindow(p_parent)
{
  ...
  connect(m_musicFileDisplayWidget, SIGNAL(hasItemSelection(bool)), m_saveAndPrev, SLOT(setEnabled(bool)));
  connect(m_musicFileDisplayWidget, SIGNAL(hasItemSelection(bool)), m_saveAndNext, SLOT(setEnabled(bool)));
  ...
  connect(m_saveAndNext, SIGNAL(clicked()), m_musicFileDisplayWidget, SLOT(saveCurrentAndGotoNextItem()));
  connect(m_saveAndPrev, SIGNAL(clicked()), m_musicFileDisplayWidget, SLOT(saveCurrentAndGotoPrevItem()));
}
